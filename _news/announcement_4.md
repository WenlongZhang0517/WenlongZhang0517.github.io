---
layout: post
date: 2025-6-12 07:59:00-0400
inline: true
related_posts: false
---

<!-- A simple inline announcement with Markdown emoji! :sparkles: :smile: -->
We have released the large-scale **multimodal scientific benchmark** for scientific discovery scenarios, **Scientists’ First Exam**. Welcome to download and try it on [Hugging Face](https://huggingface.co/datasets/PrismaX/SFE). One papers were accepted by **ICCV**.
