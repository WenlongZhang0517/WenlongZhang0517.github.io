...
We have released the large-scale **multimodal scientific benchmark** for scientific discovery scenarios, **Scientists’ First Exam**. Welcome to download and try it on [Hugging Face](https://huggingface.co/datasets/PrismaX/SFE).
